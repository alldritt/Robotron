...
@implementation ColorCycle2

+ (void)initialize {
    //  colorCycle2: blue(2), green(2), red(2)
    CFTimeInterval step = 1.0 / 15.0;
    
    sColorCycle = [SKAction repeatActionForever:[SKAction sequence:@[[SKAction colorizeWithColor:[SKColor robotronRedColor] colorBlendFactor:1 duration:0],
                                                                     [SKAction waitForDuration:step * 3.0],
                                                                     [SKAction colorizeWithColor:[SKColor robotronGreenColor] colorBlendFactor:1 duration:0],
                                                                     [SKAction waitForDuration:step * 3.0],
                                                                     [SKAction colorizeWithColor:[SKColor robotronBlueColor] colorBlendFactor:1 duration:0],
                                                                     [SKAction waitForDuration:step * 3.0]]]];
}
